...
function IconYouTube(props: { className?: string }) {
  return (
    <svg className={props.className} width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
export default function SongCard(props: {
  ...
  return (
    <div className="glass group rounded-2xl p-4 shadow-glow transition hover:bg-white/10">
      <div className="flex gap-3 sm:gap-4">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-start gap-3">
            <div className="relative h-16 w-16 shrink-0 overflow-hidden rounded-xl ring-1 ring-white/10 sm:h-20 sm:w-20">
              {song.albumArtUrl ? (
            ...
            <div className="min-w-0 flex-1">
              <div className="truncate font-display text-base leading-tight sm:text-lg">{song.title}</div>
          ...
          <div className="mt-3 flex w-full items-center gap-2">
            ...
            >
              <span className="truncate">{busy ? 'Voting…' : isVoted ? 'Voted' : 'Vote'}</span>
